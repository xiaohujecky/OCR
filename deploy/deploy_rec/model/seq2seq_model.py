...
class Seq2SeqModel(object):
    ...
    def __init__(self, encoder_masks, encoder_inputs_tensor, 
        ...
        if attn_num_layers > 1:
            ...
            #cell = tf.contrib.rnn.MultiRNNCell([single_cell for _ in range(attn_num_layers)], state_is_tuple=False)
        ...
        #softmax_loss_function = tf.nn.sparse_softmax_cross_entropy_with_logits  # xiaohu 
